...
namespace Tch.RestClient.UnitTests.UseCases.Put
{
   public class HappyTests : UnitTestBase<IRestClient>
   {
      ...
      public async Task No_Content()
      {
         ...
         //assert
         var responseDto = await SUT().Put(url, httpHeaders);
      ...
      public async Task Json_Content()
      {
         ...
         //assert
         var responseDto = await SUT().Put(url, jsonText, httpHeaders);
      ...
      public async Task Mixed_Content()
      {
         ...
         //assert
         var responseDto = await SUT().Put(url, jsonText, files, httpHeaders);
