...
namespace Tch.RestClient.UnitTests.UseCases.Post
{
   public class HappyTests : UnitTestBase<IRestClient>
   {
      ...
      public async Task No_Content()
      {
         ...
         //assert
         var responseDto = await SUT().Post(url, httpHeaders);
      ...
      public async Task Json_Content()
      {
         ...
         //assert
         var responseDto = await SUT().Post(url, jsonText, httpHeaders);
      ...
      public async Task Mixed_Content()
      {
         ...
         //assert
         var responseDto = await SUT().Post(url, jsonText, files, httpHeaders);
